...
const STAGE_META = [
    ...
    { key: 'PSA Negotiation',     label: 'PSA Negotiation (Last 90 Days)', iconName: 'utility:contract', color: '#FB8C00' },
    { key: 'PSA Executed',        label: 'PSA Executed (Last 90 Days)',   iconName: 'utility:approval', color: '#E8710A' },
