 ...
 *
 * 🔴 THE PINNED LITERAL IS 'Signed' SINCE 2026-08-14 (observation 5); it was 'Completed'. This
...
import LoiMarkCompleted from 'c/loiMarkCompleted';
...
describe('c-loi-mark-completed', () => {
    ...
    function createComponent() {
        const element = createElement('c-loi-mark-completed', { is: LoiMarkCompleted });
    ...
    it('SUCCESS BRANCH: sends the hardcoded target, toasts success, notifies the record', async () => {
        advanceTo.mockResolvedValue('LOI moved to Signed.');
        ...
        expect(toastHandler.mock.calls[0][0].detail.message).toBe('LOI moved to Signed.');
