...
As of 2026-08-10 the repo has **24 `WITH SYSTEM_MODE` queries across 15 selector classes** —
`OpportunitySelector` is the newest entrant and contributes exactly one
