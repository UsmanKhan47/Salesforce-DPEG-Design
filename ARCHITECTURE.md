...
As of 2026-08-10 (Tranche 5B) the repo has **29 `WITH SYSTEM_MODE` queries across 19 selector
classes**. Tranche 5B added three across two new entrant classes and one incumbent:
