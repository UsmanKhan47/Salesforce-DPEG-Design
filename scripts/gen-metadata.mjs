...
const standardFields = {
  ...
  Opportunity: [
    ...
    { name: 'Portfolio_Deal__c', label: 'Portfolio Deal', type: 'Lookup', ref: 'Opportunity', relName: 'Child_Portfolio_Deals' },
    { name: 'Is_Portfolio_Parent__c', label: 'Is Portfolio Parent', type: 'Checkbox' },
    { name: 'Bundle_LOI__c', label: 'Bundle LOI', type: 'Checkbox' },
